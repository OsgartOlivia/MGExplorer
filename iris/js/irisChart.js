...
//	    model.indexAttText = 0;          // Indice do atributo cujo texto sera impresso
  ...
  // ---------------- Acoes de inicializacao
    var _svg = d3.select("#"+idDiv).append("svg"),  // Cria o svg sem dimensoes
		_sort  = lcv.sortIris(),                     // Cria função de ordenação
  ...
  //--------------------- 
    model.when(["data","widthChart","heightChart","barScale","pInnerRadius","pOuterRadius","redraw"], 
	  function (data,widthChart,heightChart,barScale,pInnerRadius,pOuterRadius,redraw) {
...
// COnfigura para ordenar nomes dos nodos
 	...
 	//---------------------
    // Configura os dados que serão impressos no centroid e o texto da barra (Só é possível coloar label)	
