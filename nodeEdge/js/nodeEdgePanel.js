...
//-------------------------
    function _addAutocomplete( idDivPanel) {
		_searchAutocomplete = $("<input>",{class:"NE-Autocomplete"}).attr("placeholder","Search").attr("size",37);
...
/*			c =0;  // Essa era a primeira implementação para buscar pelo nome do cluster
