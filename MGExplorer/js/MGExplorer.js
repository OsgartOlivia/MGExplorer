...
//---------------	
        function _fActionEdgeNE_GM(edge, parentId) {
            ...
            _chart.chart = MatrixGlyphChart(_chart.view.idChart()).box ( {width:MG_WidthChart, height:MG_HeightChart});
...
//---------------------------------
        function _showClusterVis(node, parentId) {
            ...
            _chart.chart = ClusterVisChart(_chart.view.idChart()).box ( {width:MG_WidthChart, height:MG_HeightChart});
...
//---------------------------------	
        function _showIris(node, parentId, parent, isFromCV) {
            ...
            _chart.chart.configCentroid(ATN_ShortName,"coauthors",ATN_ShortName); // Must be before date function
